  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      try {
        ...
        console.error('Resposta bruta recebida (não JSON):', rawResponseText);
        throw new Error(`Resposta do webhook não é um JSON válido: ${rawResponseText}`);
      }
      ...
      const fallbackResponse: Message = {
        id: messages.length + 2,
        text: `Desculpe, ocorreu um erro: ${error.message}. Por favor, verifique o console para mais detalhes.`, 
        sender: 'bot',
        timestamp: new Date()
      };
      ...
      alert(`Ocorreu um erro: ${error.message}. Verifique o console para mais informações.`);
    } finally {
      setIsTyping(false);
    }
  };
